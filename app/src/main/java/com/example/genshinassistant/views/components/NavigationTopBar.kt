...
@Composable
fun NavigationTopBar(navController: NavController, showBar: Boolean = true) {
    if (showBar) {
        ...
        NavigationBar() {
                ...
                icon = {
                    Icon(
                        IconResource.fromDrawableResource(R.drawable.baseline_grid_view)
                            .asPainterResource(), contentDescription = null
                    )
                },
            ...
            NavigationBarItem(
                icon = {
                    Icon(
                        IconResource.fromImageVector(Icons.Filled.List).asPainterResource(),
            ...
            NavigationBarItem(
                icon = {
                    Icon(
                        IconResource.fromImageVector(Icons.Filled.Favorite).asPainterResource(),
                        contentDescription = null
                    )
                },
